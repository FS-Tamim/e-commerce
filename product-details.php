...
<body>
	...
	<div class="container">
		<div class="breadcrumb-inner ml-auto">
<?php
...
?>
			...
			<div class='col-md-9'>
				<div class="row  wow fadeInUp d-flex">
 ...
 <div class="single-product-gallery-item" id="slide1">
                <a data-lightbox="image-1" data-title="<?php echo htmlentities($row['productName']);?>" href="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>">
                    <img class="img-responsive" alt=""  src="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" width="400" height="500" />
                </a>
...
<?php } ?>
							<div class="stock-container info-container m-t-10 mt-2">
								<div class="row">
...
<div class="stock-container info-container m-t-10 mt-2 mb-2">
								<div class="row">
									<div class="col-sm-3 col-md-5">
										<div class="stock-box">
